...
application using the `@fedify/adonis` package.
...
3. Start the server:
   ...
   ```sh
   pnpm dev & pnpx @fedify/cli tunnel 3333
   ```

4. Open your browser tunneled URL and start interacting with the app. You can
   see your handle such as `@demo@6c10b40c63d9e1ce7da55667ef0ef8b4.serveo.net`.
