...
// Deno.test.ignore("DebugObserver - captures inbound activities", async () => {
...
// Deno.test.ignore("DebugObserver - captures outbound activities", async () => {
//   const observer = new DebugObserver();
//   const store = observer.getStore();
...
// Deno.test.ignore("DebugObserver - activity counter", async () => {
//   const observer = new DebugObserver();
//   const store = observer.getStore();
//   const context = createMockContext();
