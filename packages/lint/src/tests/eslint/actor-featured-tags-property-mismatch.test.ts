/**
 * ESLint tests for actor-featured-tags-property-mismatch rule.
 */
...
test(`ESLint: ${ruleName}`, () => {
  runESLintTests(ruleName, rule, {
    valid: createMismatchValidCases("featuredTags"),
    invalid: createMismatchInvalidCases("featuredTags", "mismatch"),
  });
});
