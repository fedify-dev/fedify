/**
 * ESLint tests for actor-featured-tags-property-required rule.
 */
...
test(`ESLint: ${ruleName}`, () => {
  runESLintTests(ruleName, rule, {
    valid: createRequiredValidCases("featuredTags"),
    invalid: createRequiredInvalidCases("featuredTags", "required"),
  });
});
