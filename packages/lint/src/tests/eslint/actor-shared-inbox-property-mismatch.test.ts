/**
 * ESLint tests for actor-shared-inbox-property-mismatch rule.
 */
...
test(`ESLint: ${ruleName}`, () => {
  runESLintTests(ruleName, rule, {
    valid: createMismatchValidCases("sharedInbox"),
    invalid: createMismatchInvalidCases("sharedInbox", "mismatch"),
  });
});
