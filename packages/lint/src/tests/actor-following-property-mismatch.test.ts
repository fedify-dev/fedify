...
import {
  ACTOR_FOLLOWING_PROPERTY_MISMATCH as ruleName,
  default as rule,
...
const tests = createMismatchRuleTests("following", config);
test(
...
// Edge case tests
const edgeCases = createMismatchEdgeCaseTests("following", config);
test(
