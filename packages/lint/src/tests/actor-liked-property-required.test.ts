...
const tests = createRequiredDispatcherRuleTests("liked", config);
test(
...
test(
  `${ruleName}: ✅ Edge - if else if else with liked in all branches`,
  edgeCases["if else if else with property in all branches"],
);
test(
  `${ruleName}: ❌ Edge - if else if else missing liked in else if`,
  edgeCases["if else if else missing property in else if"],
);
test(
  `${ruleName}: ✅ Edge - if else if with final return liked in all paths`,
  edgeCases["if else if with final return property in all paths"],
);
test(
  `${ruleName}: ❌ Edge - if else if with final return missing liked in final return`,
