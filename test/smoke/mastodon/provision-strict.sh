#!/usr/bin/env bash
# Provision Mastodon for strict-mode smoke tests (HTTPS + signature verification).
#
# Differences from provision.sh:
...
COMPOSE="docker compose -f test/smoke/mastodon/docker-compose.strict.yml"
